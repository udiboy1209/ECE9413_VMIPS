...
SRL SR1 SR1 SR7   #divide SR3 by 2
MTCL SR1            #set vector length = SR3/2
LV VR3 SR6
ADD SR3 SR6 SR1
LV VR4 SR3         #splitting vectors into half
ADDVV VR3 VR3 VR4 #adding each half together
BGT SR1 SR7 -7    #stay in loop till vector length is 1
###
